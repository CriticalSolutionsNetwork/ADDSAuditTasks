...
Get-ADDSAssetInventoryAudit [-HostType] <String> [[-DaystoConsiderAHostInactive] <Int32>] [[-Report]] [[-DirPath] <String>] [<CommonParameters>]

Get-ADDSAssetInventoryAudit [-OSType] <String> [[-DaystoConsiderAHostInactive] <Int32>] [[-Report]] [[-DirPath] <String>] [<CommonParameters>]
...
| <nobr>DirPath</nobr> |  | The path to the -Report output directory. | false | false | C:\\Temp\\ |
### Note
